...
func cliproxyPluginCall(method *C.char, request *C.uint8_t, requestLen C.size_t, response *C.cliproxy_buffer) C.int {
	...
	if method == nil {
		writeResponse(response, mustErrorEnvelope("invalid_method", "method is required", 400))
		return 1
	}
	...
	if err != nil {
		...
		writeResponse(response, mustErrorEnvelope(pe.Code, pe.Message, pe.HTTPStatus))
		return 1
	}
